                  ...
                  <CardContent className="flex aspect-square items-center justify-center p-6">
                    <div className="absolute bottom-3 mx-auto">
                      <Image
                        ...
                        width={60}
                        height={60}
                        className="border-[8px] border-white rounded-full overflow-hidden mx-auto transform transition-all duration-300 ease-in-out group-hover:scale-110"
                        src={review.user.userImage}
                      />
                      <div className="bg-white rounded-xl max-w-[95%] object-cover mx-auto text-center px-4 py-7 shadow-lg group-hover:bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 group-hover:text-white transition-colors duration-300 ease-in-out">
